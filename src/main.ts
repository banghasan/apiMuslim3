...
const perawiDbFile = new URL("../data/hadis/rawi/perawi.sqlite", import.meta.url);
...
const hadisEncDbFile = new URL("../data/hadis/enc/data.sqlite", import.meta.url);
...
app.get("/", (c) =>
  c.json({
    status: true,
    message: "Selamat datang di API Muslim myQuran",
    data: {
      ver: "3.0",
...
Kolom kota dan kabupaten telah disesuaikan sebagaimana sumber.`,
  },
  {
    name: "Hadis",
    description:
      "Ensiklopedia Hadis dengan navigasi berdasarkan ID, akses acak, serta eksplorasi dengan pagination.",
  },
  {
    name: "Kalender",
